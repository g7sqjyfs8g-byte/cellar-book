...
function setupSheets() {
  ...
  if (t.getLastRow() === 0) {
    const headers = ["id","name","producer","vintage","region","country","grape","style",
                     "jmRating","nickyRating","notes","pairing","price","location","buyAgain","date","label","hallidayRating"];
    t.appendRow(headers);
  ...
  if (c.getLastRow() === 0) {
    const headers = ["id","name","producer","vintage","region","country","grape","style",
                     "quantity","drinkFrom","drinkBy","price","location","notes","dateAdded","label","hallidayRating"];
    c.appendRow(headers);
